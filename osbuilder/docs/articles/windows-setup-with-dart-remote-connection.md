...
This is an easy How To.  You must first use OSBuilder with this [How To](../functions/osbuild/new-osbuildtask-winpe/winpe-dart.md).  OSBuilder will add DaRT to WinPE \(Boot.wim Index 1\), WinRE, and Windows Setup \(Boot.wim Index 2\).  Now create an ISO or USB and boot up the OS.
