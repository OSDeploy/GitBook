...
This is an easy How To.  You must first use OSBuilder to [Microsoft DaRT to WinPE](add-dart-to-winpe.md).  OSBuilder will add DaRT to WinPE \(Boot.wim Index 1\), WinRE, and Windows Setup \(Boot.wim Index 2\).  Now create an ISO or USB and boot up the OS.
