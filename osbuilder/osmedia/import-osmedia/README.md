...
Creates an ISO of the imported **OSMedia** in the **&lt;OSMediaPath&gt;\ISO** directory using the **OSBuilder** [**`New-MediaISO`**](../../docs/shared-functions/new-mediaiso.md) function.  The following command line is passed

```text
New-MediaISO -OSMediaPath "$OSMediaPath
```

{% page-ref page="../../docs/shared-functions/new-mediaiso.md" %}

## -ShowOSInfo

**Usage:  `Import-OSMedia -ShowOSInfo`**

Displays the full **OSMedia** Information by executing the **OSBuilder** [**`Show-OSInfo`**](../../docs/shared-functions/show-osinfo.md) function.  The following command line is passed

```text
Show-OSInfo -OSMediaPath $OSMediaPath
```

{% page-ref page="../../docs/shared-functions/show-osinfo.md" %}
