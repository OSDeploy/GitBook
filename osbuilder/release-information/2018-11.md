...
**`-ByTaskName`** parameter allows the automation of [**`New-OSBuild`**](../docs/functions/osbuild/new-osbuild.md) and the **`-CreateISO`** parameter automatically creates a [**`New-MediaISO`**](../docs/functions/media/new-mediaiso.md)**\`\`**
