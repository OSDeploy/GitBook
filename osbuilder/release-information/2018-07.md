...
* Create a Bootable OS USB with [New-OSBuilderUSB](../docs/shared-functions/new-mediausb.md)
...
* **New Documentation**
  * [How To: Create an OS USB](../docs/shared-functions/new-mediausb.md)
...
* **Added** [**Show-OSInfo**](../docs/shared-functions/show-osinfo.md) **function**
* **New Documentation**
  * [How To: Show OS Information](../docs/shared-functions/show-osinfo.md)
