...
* Create a Bootable OS USB with [New-OSBuilderUSB](../docs/functions/osbuilder/new-mediausb.md)
...
* **New Documentation**
  * [How To: Create an OS USB](../docs/functions/osbuilder/new-mediausb.md)
...
* **Added** [**Show-OSInfo**](../docs/functions/osbuilder/show-osinfo.md) **function**
* **New Documentation**
  * [How To: Show OS Information](../docs/functions/osbuilder/show-osinfo.md)
