...
* Create a Bootable OS USB with [New-OSBuilderUSB](../docs/how-to/new-mediausb.md)
...
* **New Documentation**
  * [How To: Create an OS USB](../docs/how-to/new-mediausb.md)
...
* **Added** [**Show-OSInfo**](../docs/how-to/show-osinfo.md) **function**
* **New Documentation**
  * [How To: Show OS Information](../docs/how-to/show-osinfo.md)
