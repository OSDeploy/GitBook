...
**`-ByTaskName`** parameter allows the automation of [**`New-OSBuild`**](../../../osbuilder/docs/functions/osbuild/new-osbuild.md) and the **`-CreateISO`** parameter automatically creates a [**`New-MediaISO`**](../../../osbuilder/docs/functions/osbmedia/new-osbmediaiso.md)**\`\`**
