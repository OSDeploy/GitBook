...
* [Docs](osdbuilder/docs/README.md)
  ...
  * [Basics](osdbuilder/docs/basics/README.md)
    ...
    * [Customize an Operating System](osdbuilder/docs/basics/create-an-osbuild/README.md)
      * [Basic Task](osdbuilder/docs/basics/create-an-osbuild/basic-task.md)
      * [Parameter Task](osdbuilder/docs/basics/create-an-osbuild/parameter-task.md)
      * [Templates](osdbuilder/docs/basics/create-an-osbuild/templates.md)
